...
public class TryMe {
	...
	public static void addData() {
		...
		Location l = new Location("DIY store", "Række 34", "Hylde 234", 20, 400);
		...
		Location l1 = new Location("DIY store", "Række 12", "Hylde 222", 10, 30);
		...
		Location l2 = new Location("DIY store", "Række 14", "Hylde 134", 10, 30);
		...
		Location l3 = new Location("DIY store", "Række 12", "Hylde 334", 40, 100);
		...
		Location l4 = new Location("DIY store", "Række 17", "Hylde 534", 5, 20);
		...
		Location l5 = new Location("DIY store", "Række 22", "Hylde 214", 30, 500);
		...
		Location l8 = new Location("DIY store", "Række 29", "Hylde 274", 10, 50);
